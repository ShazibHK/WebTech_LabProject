...
console.log(props.number)
    const handleSubmit = async (e) => {
        ...
        setIncome(income + parseInt(props.location.aboutprops.product.comission)*parseInt(props.location.aboutprops.product.price));
        ...
        dispatch(updateTransaction("60c662bea27bec0968e9ad5e","income",income));
        clear();
    };
