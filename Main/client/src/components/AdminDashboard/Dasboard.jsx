          ...
          <div className="main__cards">
            <div className="card">
              ...
              <div className="card_inner">
                ...
                <span Name="font-bold text-title">{!notifications.length?"1":notifications.length}</span>
              </div>
            </div>
          ...
          <div className="charts">
            ...
            <div className="charts__left">
              ...
              <div className="charts__right__cards">
                ...
                <div className="card3">
                  <h1>Partners</h1>
                  <PartnerCount countpartner="countpartner"/>
                </div>
      ...
      <div id="sidebar">
        ...
        <div className="sidebar__menu">
          ...
          <div className="sidebar__link">
            ...
            <a href="OfferedTrades">Product Trades</a>
          </div>
          <div className="sidebar__link">
